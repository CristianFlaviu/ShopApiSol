...
namespace ShopApi.Core.Email
{
    ...
    <table style=""border-collapse:collapse;table-layout:fixed;min-width:320px;width:100%;background-color:#f2f4f6;""
      ...
      <tbody>
        ...
        public static string UnpaidOrder = @"  <div>
    <table style=""border-collapse:collapse;table-layout:fixed;min-width:320px;width:100%;background-color:#f2f4f6;""
      cellpadding=""0"" cellspacing=""0"" role=""presentation"">
                  ...
                  <div style=""border-collapse:collapse;display:table;width:100%;"">
                    ...
                    <div style=""max-width:600px;
                      ...
                      <div style=""Margin-left:20px;Margin-right:20px;"">
                        <div
                          style=""font-size:12px;font-style:normal;font-weight:normal;line-height:19px;Margin-bottom:20px;"">
                            <img style=""height:100px;border:0;display:block;height:auto;width:100%;max-width:200px;""
                              alt=""Shop Assistant logo""
                              src=""https://i.ibb.co/N9rZ7ZK/late.jpg"">
                        </div>
                      </div>
                      ...
                      <div style=""Margin-left:20px;Margin-right:20px;"">
                        <p style=""Margin-top:0;Margin-bottom:20px;font-size:20px"">Hi {0},</p>
                      </div>
                ...
                <div style=""Margin:0 auto;
                  ...
                  <div style=""border-collapse:collapse;
                    ...
                    <div
                      ...
                      <div style=""Margin-left:20px;Margin-right:20px;"">
                        <div style="""">
                          <p style=""Margin-top:0;Margin-bottom:20px;"">You have an unpaid order from  {2}.</p>
                        </div>
                      </div>
                      ...
                      <div style=""Margin-left:20px;Margin-right:20px;"">
                        <div style=""Margin-bottom:20px;text-align:left;"">
                          <a style=""border-radius:4px;
                                    ...
                                    color:#ffffff !important;
                                    background-color:#7856ff;
                                    font-family:sans-serif;"" href={1}>Visit Shop Assistant</a>
                        </div>
                      </div>
